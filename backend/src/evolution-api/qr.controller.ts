...
export class QrController {
  ...
  async getQrCode(
    ...
    this.logger.log(
      `Solicitud de QR para la instancia con ID numérico: ${id} desde la ubicación: ${locationId}`,
    );
    ...
    try {
      ...
      this.logger.log(
        `Estado de la instancia actualizado a 'qr_code' para: ${instance.instanceName}`,
      ...
      throw new InternalServerErrorException(
        "Error al obtener el código QR de la API de Evolution",
      );
    }
  }
}
