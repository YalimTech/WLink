...
export class GhlOauthController {
  ...
  async callback(
    ...
    this.logger.log(
      `GHL OAuth callback received. Code: ${code ? 'present' : 'MISSING'}`,
    );
    ...
    try {
      ...
      this.logger.log(
        `Stored/updated GHL tokens for User (Location ID): ${respLocationId}`,
      );
        ...
        <html lang="en">
          ...
          <body>
            <div class="container">
              ...
              <div class="highlight">
                You can now manage your WhatsApp instances through the Evolution API
                WhatsApp app's page (located in the navigation panel on the left).
              </div>
